...
CommissionEmployee::CommissionEmployee(const string& first,
  ...
  // If you can initialize a member in initializer list it's always better
...
// calculate earnings
 double CommissionEmployee::earnings() const {
  return getCommissionRate() * getGrossSales(); // even inside your classes it's better to use get and set member functions to manipulate members
}

// return string representation of CommissionEmployee object
string CommissionEmployee::print() const {
